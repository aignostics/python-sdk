...
class ExternalsApi:
    ...
    def create_user_v1_users_post(
        ...
        :param user_creation_request: (required)
        :type user_creation_request: UserCreationRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _create_user_v1_users_post_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if user_creation_request is not None:
            _body_params = user_creation_request
    ...
    def get_run_v1_runs_application_run_id_get(
        self,
        application_run_id: StrictStr,
        include: Annotated[list[Any], Field(min_length=1, max_length=1)] | None = None,
        _request_timeout: None | Annotated[StrictFloat, Field(gt=0)] | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
        _request_auth: dict[StrictStr, Any] | None = None,
        _content_type: StrictStr | None = None,
        _headers: dict[StrictStr, Any] | None = None,
    ...
    def list_run_results_v1_runs_application_run_id_results_get(
        self,
        application_run_id: StrictStr,
        item_id__in: list[StrictStr | None] | None = None,
        page: Annotated[int, Field(strict=True, ge=1)] | None = None,
        page_size: Annotated[int, Field(le=100, strict=True, ge=5)] | None = None,
        reference__in: list[StrictStr] | None = None,
        status__in: list[ItemStatus] | None = None,
        sort: list[StrictStr] | None = None,
        _request_timeout: None | Annotated[StrictFloat, Field(gt=0)] | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
        _request_auth: dict[StrictStr, Any] | None = None,
        _content_type: StrictStr | None = None,
