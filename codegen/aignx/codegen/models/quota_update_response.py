...
class QuotaUpdateResponse(BaseModel):
    """
    PATCH response payload for quota update.
    """
    name: QuotaName
    quota: StrictInt
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of QuotaUpdateResponse from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of QuotaUpdateResponse from a dict"""
        if obj is None:
            return None
