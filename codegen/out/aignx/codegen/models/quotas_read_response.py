...
from aignx.codegen.models.quota_read_response import QuotaReadResponse
from typing import Optional, Set
from typing_extensions import Self

class QuotasReadResponse(BaseModel):
    """
    GET response payload for multiple quota reads.
    """ # noqa: E501
    quotas: List[QuotaReadResponse]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QuotasReadResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QuotasReadResponse from a dict"""
        if obj is None:
            return None
