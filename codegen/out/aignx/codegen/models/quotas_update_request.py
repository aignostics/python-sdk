...
from aignx.codegen.models.quota_update_request import QuotaUpdateRequest
from typing import Optional, Set
from typing_extensions import Self

class QuotasUpdateRequest(BaseModel):
    """
    PATCH request payload for quota updates.
    """ # noqa: E501
    quotas: List[QuotaUpdateRequest]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QuotasUpdateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QuotasUpdateRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "quotas": [QuotaUpdateRequest.from_dict(_item) for _item in obj["quotas"]] if obj.get("quotas") is not None else None
        })
        return _obj
