...
class ItemEventCreationResponse(BaseModel):
    """
    ItemEventCreationResponse
    """ # noqa: E501
    item_id: StrictStr
    status: ItemStatus
    __properties: ClassVar[List[str]] = ["item_id", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ItemEventCreationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ItemEventCreationResponse from a dict"""
        if obj is None:
            return None
