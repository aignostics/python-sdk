...
class OrganizationCreationRequest(BaseModel):
    ...
    slide_quota: StrictInt
    batch_size: StrictInt
    __properties: ClassVar[List[str]] = ["organization_id", "owner_email", "slide_quota", "batch_size"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganizationCreationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganizationCreationRequest from a dict"""
        if obj is None:
            return None
