...
* `[NOTEBOOK]`: Path to the notebook file to run. If not provided, a default notebook will be used.  [default: /home/neelay/work/python-sdk/src/aignostics/notebook/_notebook.py]
...
* `--destination DIRECTORY`: Path pointing to directory where the input and output schemata will be dumped.  [default: /home/neelay/work/python-sdk]
...
* `--upload-prefix TEXT`: Prefix for the upload destination. If not given will be set to current milliseconds.  [default: 1762792479396.364]
...
* `--application-version TEXT`: Version of the application. If not provided, the latest version will be used.
* `--upload-prefix TEXT`: Prefix for the upload destination. If not given will be set to current milliseconds.  [default: 1762792479396.5398]
...
* `[DESTINATION_DIRECTORY]`: Destination directory to download results to  [default: /home/neelay/snap/code/211/.local/share/aignostics/results]
...
* `[TARGET]`: target directory for download  [default: /home/neelay/snap/code/211/.local/share/aignostics/datasets/idc]
...
* `[DESTINATION_DIRECTORY]`: Destination directory to download to  [default: /home/neelay/snap/code/211/.local/share/aignostics/datasets/aignostics]
...
* `run-metadata-schema`: Print the JSON Schema for Run SDK metadata.
* `item-metadata-schema`: Print the JSON Schema for Item SDK metadata.

### `aignostics sdk run-metadata-schema`
...
```console
$ aignostics sdk run-metadata-schema [OPTIONS]
```
...
### `aignostics sdk item-metadata-schema`
...
```console
$ aignostics sdk item-metadata-schema [OPTIONS]
```
...
* `--path DIRECTORY`: Path to install QuPath to. If not specified, the default installation path will be used.Do not change this unless you know what you are doing.  [default: /home/neelay/snap/code/211/.local/share/aignostics]
...
* `-j, --json`: Output the running QuPath processes as JSON.
* `--help`: Show this message and exit.
