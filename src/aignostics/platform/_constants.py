...
STATUS_PAGE_URL_DEV: str | None = None  # No dedicated public Betterstack status page for dev
...
STATUS_PAGE_URL_TEST: str | None = None  # No dedicated public Betterstack status page for test
