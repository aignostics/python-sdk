...
import aignostics_sdk._codegen.models
from aignostics_sdk._codegen import rest
from aignostics_sdk._codegen.api_response import ApiResponse
from aignostics_sdk._codegen.api_response import T as ApiResponseT
from aignostics_sdk._codegen.configuration import Configuration
...
class ApiClient:
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(aignostics_sdk._codegen.models, klass)
    ...
    def __deserialize_file(self, response):
        ...
        pathlib.Path(path).write_bytes(response.data)
