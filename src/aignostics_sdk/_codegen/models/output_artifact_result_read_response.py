...
from aignostics_sdk._codegen.models.artifact_output import ArtifactOutput
from aignostics_sdk._codegen.models.artifact_state import ArtifactState
from aignostics_sdk._codegen.models.artifact_termination_reason import ArtifactTerminationReason
...
class OutputArtifactResultReadResponse(BaseModel):
    ...
    termination_reason: ArtifactTerminationReason | None = None
    ...
    download_url: Annotated[str, Field(min_length=1, strict=True, max_length=2083)] | None = None
    __properties: ClassVar[list[str]] = ["output_artifact_id", "name", "metadata", "state", "termination_reason", "output", "error_code", "error_message", "download_url"]
