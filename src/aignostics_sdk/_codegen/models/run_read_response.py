...
from aignostics_sdk._codegen.models.run_item_statistics import RunItemStatistics
from aignostics_sdk._codegen.models.run_output import RunOutput
from aignostics_sdk._codegen.models.run_state import RunState
from aignostics_sdk._codegen.models.run_termination_reason import RunTerminationReason
from aignostics_sdk._codegen.models.scheduling_response import SchedulingResponse
...
class RunReadResponse(BaseModel):
    ...
    num_preceding_items_org: StrictInt | None = None
    num_preceding_items_platform: StrictInt | None = None
    scheduling: SchedulingResponse | None = None
    __properties: ClassVar[list[str]] = ["run_id", "application_id", "version_number", "state", "output", "termination_reason", "error_code", "error_message", "statistics", "custom_metadata", "custom_metadata_checksum", "submitted_at", "submitted_by", "terminated_at", "num_preceding_items_org", "num_preceding_items_platform", "scheduling"]
