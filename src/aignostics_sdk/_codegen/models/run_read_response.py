...
from aignx.codegen.models.scheduling_response import SchedulingResponse
...
class RunReadResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["run_id", "application_id", "version_number", "state", "output", "termination_reason", "error_code", "error_message", "statistics", "custom_metadata", "custom_metadata_checksum", "submitted_at", "submitted_by", "organization_id", "terminated_at", "num_preceding_items_org", "num_preceding_items_platform", "scheduling"]
