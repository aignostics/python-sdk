...
from aignx.codegen.models.scheduling_request import SchedulingRequest
...
class RunCreationRequest(BaseModel):
    ...
    scheduling: Optional[SchedulingRequest] = None
    ...
    __properties: ClassVar[List[str]] = ["application_id", "version_number", "custom_metadata", "scheduling", "callback_context", "items"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if callback_context (nullable) is None
        # and model_fields_set contains the field
        if self.callback_context is None and "callback_context" in self.model_fields_set:
            _dict['callback_context'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "callback_context": obj.get("callback_context"),
