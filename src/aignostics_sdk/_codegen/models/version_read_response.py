...
from aignostics_sdk._codegen.models.input_artifact import InputArtifact
from aignostics_sdk._codegen.models.output_artifact import OutputArtifact
...
class VersionReadResponse(BaseModel):
    ...
    """
    version_number: Annotated[str, Field(strict=True)] = Field(description="Semantic version of the application")
