...
from aignostics_sdk._codegen.models.input_artifact_result_read_response import InputArtifactResultReadResponse
from aignostics_sdk._codegen.models.item_output import ItemOutput
...
from aignostics_sdk._codegen.models.output_artifact_result_read_response import OutputArtifactResultReadResponse
...
class ItemResultReadResponse(BaseModel):
    ...
    custom_metadata_checksum: StrictStr | None = None
    queue_position_org: StrictInt | None = None
    queue_position_platform: StrictInt | None = None
    ...
    input_artifacts: list[InputArtifactResultReadResponse] = Field(description=" The input artifact(s) provided by the user. For most applications, this will be one artifact that defines the whole slide image to be processed.     ")
    ...
    __properties: ClassVar[list[str]] = ["item_id", "external_id", "custom_metadata", "custom_metadata_checksum", "queue_position_org", "queue_position_platform", "state", "output", "termination_reason", "error_code", "error_message", "terminated_at", "input_artifacts", "output_artifacts"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "input_artifacts": [InputArtifactResultReadResponse.from_dict(_item) for _item in obj["input_artifacts"]] if obj.get("input_artifacts") is not None else None,
