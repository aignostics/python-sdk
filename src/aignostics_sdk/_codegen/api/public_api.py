...
from aignostics_sdk._codegen.api_client import ApiClient, RequestSerialized
from aignostics_sdk._codegen.api_response import ApiResponse
from aignostics_sdk._codegen.models.application_read_response import ApplicationReadResponse
from aignostics_sdk._codegen.models.application_read_short_response import ApplicationReadShortResponse
from aignostics_sdk._codegen.models.custom_metadata_update_request import CustomMetadataUpdateRequest
from aignostics_sdk._codegen.models.custom_metadata_update_response import CustomMetadataUpdateResponse
from aignostics_sdk._codegen.models.item_result_read_response import ItemResultReadResponse
from aignostics_sdk._codegen.models.item_state import ItemState
from aignostics_sdk._codegen.models.item_termination_reason import ItemTerminationReason
from aignostics_sdk._codegen.models.me_read_response import MeReadResponse
from aignostics_sdk._codegen.models.run_creation_request import RunCreationRequest
from aignostics_sdk._codegen.models.run_creation_response import RunCreationResponse
...
from aignostics_sdk._codegen.models.version_read_response import VersionReadResponse
from aignostics_sdk._codegen.rest import RESTResponseType
...
class PublicApi:
    ...
    def list_applications_v1_applications_get(
        ...
        page_size: Annotated[int, Field(le=100, strict=True, ge=5)] | None = None,
        sort: Annotated[list[StrictStr] | None, Field(description="Sort the results by one or more fields. Use `+` for ascending and `-` for descending order.  **Available fields:** - `application_id` - `name` - `description` - `regulatory_classes`  **Examples:** - `?sort=application_id` - Sort by application_id ascending - `?sort=-name` - Sort by name descending - `?sort=+description&sort=name` - Sort by description ascending, then name descending")] = None,
        _request_timeout: None | Annotated[StrictFloat, Field(gt=0)] | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
        _request_auth: dict[StrictStr, Any] | None = None,
        _content_type: StrictStr | None = None,
        _headers: dict[StrictStr, Any] | None = None,
    ...
    def list_run_items_v1_runs_run_id_items_get(
        self,
        run_id: Annotated[StrictStr, Field(description="Run id, returned by `POST /v1/runs/` endpoint")],
        item_id__in: Annotated[list[StrictStr] | None, Field(description="Filter for item ids")] = None,
        external_id__in: Annotated[list[StrictStr] | None, Field(description="Filter for items by their external_id from the input payload")] = None,
        state: Annotated[ItemState | None, Field(description="Filter items by their state")] = None,
        termination_reason: Annotated[ItemTerminationReason | None, Field(description="Filter items by their termination reason. Only applies to TERMINATED items.")] = None,
        custom_metadata: Annotated[Annotated[str, Field(strict=True, max_length=1000)] | None, Field(description="JSONPath expression to filter items by their custom_metadata")] = None,
        page: Annotated[int, Field(strict=True, ge=1)] | None = None,
        page_size: Annotated[int, Field(le=100, strict=True, ge=5)] | None = None,
        sort: Annotated[list[StrictStr] | None, Field(description="Sort the items by one or more fields. Use `+` for ascending and `-` for descending order.                 **Available fields:** - `item_id` - `external_id` - `custom_metadata` - `terminated_at` - `termination_reason`  **Examples:** - `?sort=item_id` - Sort by id of the item (ascending) - `?sort=-external_id` - Sort by external ID (descending) - `?sort=custom_metadata&sort=-external_id` - Sort by metadata, then by external ID (descending)")] = None,
        _request_timeout: None | Annotated[StrictFloat, Field(gt=0)] | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
        _request_auth: dict[StrictStr, Any] | None = None,
        _content_type: StrictStr | None = None,
        _headers: dict[StrictStr, Any] | None = None,
